...
export class AllExceptionsFilter implements ExceptionFilter {
    ...
    private getForeignKeyViolationMessage(error: any): string {
        ...
        if (message.toLowerCase().includes('delete') || detail.toLowerCase().includes('still referenced')) {
            return 'El recurso tiene registros relacionados y no puede eliminarse';
        }
